...
export function ExchangeRatePill() {
  ...
  if (!rateData) {
    return (
      <div className="flex h-[38px] w-[180px] items-center justify-between rounded-xl border border-white/[0.08] bg-[#1A1A1A] p-1.5 pl-3">
  ...
  return (
    <div className="flex items-center gap-3 rounded-xl border border-white/[0.08] bg-[#1A1A1A] p-1.5 pl-3 shadow-2xl">
      ...
      <button
        ...
        className={`flex size-7 items-center justify-center rounded-lg border-1 ${activeBorderClass} bg-[#242424] transition-all hover:bg-[#2A2A2A] active:scale-95`}
      >
