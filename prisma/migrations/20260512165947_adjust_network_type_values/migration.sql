/*
  ...
  - The values [evm,svm,btc,ton] on the enum `enum_networks_network_type` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "enum_networks_network_type_new" AS ENUM ('fiat_to_crypto', 'crypto_to_fiat');
...
-- AlterTable
ALTER TABLE "User" ADD COLUMN     "permission" JSONB[];
