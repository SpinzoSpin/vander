...
export default function CreateNetworkPage() {
  return (
    <div className="flex flex-1 flex-col p-8 text-[#ededed] lg:p-10">
      <div className="mx-auto w-full max-w-3xl">
        ...
        <div className="mb-8 flex items-center justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-[#888] text-muted-foreground">
          ...
          <div className="flex gap-3">
            <Button
              asChild
              variant="destructive"
              className="h-9 border-[#282828] bg-transparent text-sm hover:bg-[#1a1a1a]"
            >
        ...
        <form className="space-y-8">
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="h-10 border-[#282828] bg-[#121212] text-white"
                />
              </div>
              <div className="space-y-2">
                <Label className="text-sm text-[#a0a0a0]">
                ...
                <Input
                  placeholder="e.g. ETH"
                  className="h-10 border-[#282828] bg-[#121212] text-white uppercase"
                />
              </div>
              <div className="space-y-2">
                <Label className="text-sm text-[#a0a0a0]">Network Type</Label>
                <Input
              ...
              <div className="space-y-2">
                ...
                <Input
                  placeholder="https://..."
                  className="h-10 border-[#282828] bg-[#121212] font-mono text-sm text-white"
                />
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6 pt-4">
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              ...
              <div className="space-y-2">
                <Label className="text-sm text-[#a0a0a0]">USDT Decimals</Label>
                <Input
                  type="number"
                  defaultValue={6}
                  className="h-10 border-[#282828] bg-[#121212] text-white"
          ...
          <div className="space-y-6 pt-4 pb-10">
            ...
            <div className="flex items-center justify-between rounded-xl border border-[#282828] bg-[#121212] p-5">
